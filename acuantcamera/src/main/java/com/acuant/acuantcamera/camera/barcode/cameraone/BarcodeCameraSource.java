...
import com.acuant.acuantcamera.camera.document.cameraone.DocumentCameraSourcePreview;
...
public class BarcodeCameraSource {
    ...
    public static class Builder {
        ...
        private BarcodeCameraSource barcodeCameraSource = new BarcodeCameraSource();
        ...
        public Builder(Context context, Detector<?> detector) {
            ...
            mDetector = detector;
            barcodeCameraSource.mContext = context;
        }
        ...
        public Builder setRequestedFps(float fps) {
            ...
            barcodeCameraSource.mRequestedFps = fps;
            return this;
        }

        public Builder setFocusMode(@FocusMode String mode) {
            barcodeCameraSource.mFocusMode = mode;
            return this;
        }
        ...
        public Builder setFlashMode(@FlashMode String mode) {
            barcodeCameraSource.mFlashMode = mode;
            return this;
        }
        ...
        public Builder setRequestedPreviewSize(int width, int height) {
            ...
            barcodeCameraSource.mRequestedPreviewWidth = width;
            barcodeCameraSource.mRequestedPreviewHeight = height;
            return this;
        }
        ...
        public Builder setFacing(int facing) {
            ...
            barcodeCameraSource.mFacing = facing;
            return this;
        }
         ...
         */
        public BarcodeCameraSource build() {
            barcodeCameraSource.mFrameProcessor = barcodeCameraSource.new FrameProcessingRunnable(mDetector);
            return barcodeCameraSource;
        }
    }
    ...
    public BarcodeCameraSource start() throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
    ...
    @RequiresPermission(Manifest.permission.CAMERA)
    public BarcodeCameraSource start(SurfaceHolder surfaceHolder, BarcodeCameraSourcePreview preview) throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
     ...
     * {@link #start(SurfaceHolder, BarcodeCameraSourcePreview)}.
     * <p/>
     ...
     * activated previously with {@link #start()} or {@link #start(SurfaceHolder, BarcodeCameraSourcePreview)}.  The camera
     ...
     * (between {@link #start()} or {@link #start(SurfaceHolder, BarcodeCameraSourcePreview)} and before {@link #stop()} or {@link #release()}).
     * <p/>
