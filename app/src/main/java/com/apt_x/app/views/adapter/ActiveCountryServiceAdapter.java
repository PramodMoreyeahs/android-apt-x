...
public class ActiveCountryServiceAdapter extends RecyclerView.Adapter<ActiveCountryServiceAdapter.ServicesViewHolder> {
    private final ActiveCountryServicveActivity context;
    ...
    public ActiveCountryServiceAdapter(ActiveCountryServicveActivity context, List<GetCountryServiceResponse.DataEntity> serviceList,
    ...
    public void onBindViewHolder(@NonNull ServicesViewHolder holder, int position) {
        ...
        System.out.println("DataEntityprint::" + obj.getBankdeposit());
            ...
            if(getExchangeRateModel.getStatus())
            {
                ...
                if(currencyStatus)
                {
                    if (!Places.isInitialized())
                        Places.initialize(context, Constants.GooglPlaceApikey);
