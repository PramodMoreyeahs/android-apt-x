...
import com.apt_x.app.databinding.ActivityCountryListBinding;
...
import com.apt_x.app.views.adapter.CountryAdapter;
...
public class CountryListActivity extends BaseActivity {
    ...
    float rate=0;
    boolean comefrom;
    Context context = CountryListActivity.this;
    Activity activity = CountryListActivity.this;
    ...
    public void initializeViews() {
        ...
        comefrom=getIntent().getBooleanExtra("comefrom",false);
    ...
    private void intAdapter() {
            myAdapter = new CountryAdapter(this, transactionArrayList,viewModel,apicalls);
    ...
    Observer<GetCountryServiceResponse> transaction_response_observer= new Observer<GetCountryServiceResponse>() {
        ...
        public void onChanged(@Nullable GetCountryServiceResponse loginBean) {
            if (loginBean == null) {
                Utils.showAlert(CountryListActivity.this, "", getString(R.string.server_error), getString(R.string.ok), "", AppUtils.dialog_ok_click, viewModel);
                return;
            }
